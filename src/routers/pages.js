...
router.get("/createanaccount",auth.islogout, connecttocontroller.insertuser_view);
...
router.get("/organizeTrip",auth.isloggedin, connecttocontroller.organize_trip_view);
...
router.post("/myaccount", connecttocontroller.updating_profile_picture_controller, connecttocontroller.myaccount);

router.get('/triphistory', connecttocontroller.trip_history_view)

router.get(
  "/goforatour/busdetails",
  connecttocontroller.goforatour_busdetails_view
);
